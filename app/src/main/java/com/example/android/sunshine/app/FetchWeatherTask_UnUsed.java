...
public class FetchWeatherTask_UnUsed extends AsyncTask<String, Void, String[]> {

    private final String LOG_TAG = FetchWeatherTask_UnUsed.class.getSimpleName();
...
//    }
    ...
    public FetchWeatherTask_UnUsed(Context context) {
        mContext = context;
    }
